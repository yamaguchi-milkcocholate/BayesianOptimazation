...
plot_experiments(
    function_name='Gaussian mixture function', dim=['30D_e0033t0167', '30D-5D'],
...
plot_experiments(
    function_name='Gaussian mixture function', dim=['30D_e0033t0167', '30D-5D'],
    method=['random_select_objective', 'copy_select_objective_diff', 'mix_select_objective_diff', 'random', 'copy', 'mix'],
